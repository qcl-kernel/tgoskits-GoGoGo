...
`irq_disabled_duration`、`mutex_inversion`、`wake_under_load` 和
`net_event_latency`。核心指标每项均为 100000 样本，并记录 expected、collected、missing、
P50/P95/P99/P99.9/max/mean 及 100 us、500 us、1 ms 超时计数。
