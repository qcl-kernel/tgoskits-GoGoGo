//! Tests for the `embedded` cpio root-filesystem archive support. The whole
//! file is gated on the feature it exercises; the host-test clippy matrix
//! builds integration tests without it.
