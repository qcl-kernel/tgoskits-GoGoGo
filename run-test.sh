...
sleep 1
timeout 60 /home/yfblock/.local/qemu-arm/bin/qemu-system-aarch64 \
  ...
  -kernel target/aarch64-unknown-linux-musl/release/axvisor.bin < /dev/null > tmp/qemu-head-test.log 2>&1
echo "EXIT:$?" >> tmp/qemu-head-test.log
