...
AXVISOR_VM_CONFIGS=$(pwd)/os/axvisor/configs/vms/qemu/aarch64/linux-net.toml:$(pwd)/os/axvisor/configs/vms/qemu/aarch64/rtthread-net.toml cargo build --release --features "qemu-aarch64-two-guest-net" -p axvisor 2>&1 | tail -5
